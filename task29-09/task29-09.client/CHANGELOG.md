...
- Create Angular project with ng: `ng new task29-09.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`task29-09.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `task29-09.client.esproj`).
